...
- media file name from `Phone/media` (for example `Ringtone.mp3`)
- absolute URL (`https://...`)
- data URI (`data:audio/...`)

Legacy alias `ringbackTone` is still accepted by the runtime for older configs.
