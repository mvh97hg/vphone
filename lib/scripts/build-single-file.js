...
async function buildSingleFile() {
    ...
    const sourceRuntimePath = path.join(libDir, 'vphone-widget.js');
    const outputMinPath = path.join(libDir, 'vphone.min.js');
    const outputWidgetMinPath = path.join(libDir, 'vphone-widget.min.js');
    ...
    fs.writeFileSync(outputWidgetMinPath, minified.code, 'utf8');
    ...
    console.log('  Output:', outputWidgetMinPath);
