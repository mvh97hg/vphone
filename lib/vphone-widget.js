...
(function(global, factory) {
    ...
    function mountFloating(mountConfig) {
        ...
        panel.style.cssText = 'width:' + mountConfig.width + ';height:' + mountConfig.height + ';background:#fff;border:1px solid #d1d5db;border-radius:14px;box-shadow:0 16px 36px rgba(0,0,0,.28);overflow:hidden;display:none;';
